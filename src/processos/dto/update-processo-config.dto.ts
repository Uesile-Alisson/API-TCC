...
export class UpdateProcessoTanqueDTO {
  ...
  @ApiPropertyOptional({
    ...
    maximum: 3,
    description:
      'Nova prioridade do tanque na fila do subsistema auxiliar. Quanto maior o valor, maior a prioridade. Ao configurar prioridades em processo com mais de um tanque, envie uma ordem completa e sem repeticoes de 1 ate a quantidade de tanques. Omita em processos com um unico tanque.',
  })
  @IsOptional()
  @Type(() => Number)
