...
describe('ProcessosSocketGateway', () => {
  ...
  it('emitTankUpdated emite atualizacao incremental apenas para sala', () => {
    ...
    const payload = {
      ...
      previous_closure_status: tank.encerramento.status,
      tank,
      reading: leituras[0],
      emitted_at: new Date('2026-01-01T00:01:00Z'),
    };
  ...
  function makeDashboard(): ProcessoDashboardData {
    return {
      ...
      parada_emergencia: {
        ativa: false,
        status: 'INATIVA',
        etapa: etapaencerramentoprocesso.NENHUMA,
        hardware_confirmado: false,
      ...
      encerramento: {
        ...
        geral: {
          status: statusencerramentoprocesso.INATIVO,
          etapa: etapaencerramentoprocesso.NENHUMA,
          automatico: true,
      ...
      tanques: [
        {
          ...
          encerramento: {
            ...
            etapa: etapaencerramentotanque.NENHUMA,
            automatico: true,
            ...
            estabilizacao: {
              ...
              leituras_observadas: 0,
              cobertura_atual_percentual: 0,
              maior_intervalo_ms: 0,
              timeout_leitura_ms: 2500,
              continuidade_aprovada: false,
            },
            retencao: {
              tempo_necessario_segundos: 30,
              perda_maxima_permitida: 2,
            },
            seguranca: {
              limite_vacuo: -95,
          ...
          estagnacao: {
            ...
            evidencias: {
              fator_volume: null,
              fator_tanques_ativos: null,
              fator_proximidade_alvo: null,
              volume_tanque: null,
              volume_medio_tanques_ativos: null,
              tanques_ativos: 1,
              vacuo_atual: -40,
              distancia_alvo: 40,
              tempo_bomba_principal_segundos: 0,
              motivo_decisao: null,
            },
          },
          leituras: [
