...
export class UpdateBombaConfiguracaoDto {
  @ApiPropertyOptional({ example: 'Bomba Principal', maxLength: 80 })
  @IsOptional()
  @IsString({ message: 'nome deve ser texto.' })
  @MaxLength(80, { message: 'nome deve ter no maximo 80 caracteres.' })
  nome?: string;

  @ApiPropertyOptional({ enum: tipobomba, example: tipobomba.PRINCIPAL })
  @IsOptional()
  @IsEnum(tipobomba, { message: 'tipo_bomba deve ser valido.' })
  tipo_bomba?: tipobomba;

  @ApiPropertyOptional({ enum: statusbomba, example: statusbomba.ATIVA })
  @IsOptional()
